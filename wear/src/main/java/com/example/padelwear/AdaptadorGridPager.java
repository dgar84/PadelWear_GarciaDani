...
public class AdaptadorGridPager extends FragmentGridPagerAdapter {
    ...
    private final String t[][] = { {"21/5/15", "juego 1", "juego 1", "juego 2", "juego 2"},
                                    {"23/5/15", "juego 1", "juego 1"} };
    private final String c[][] = { {"6-2 6-7",
                                    "6-2, 65% puntos ganados, 81% al servicio",
                                    "22 min. 623 pasos, 33º",
                                    "6-7, 48% puntos ganados, 64% al servicio",
                                    "36 min. 923 pasos, 32º"},
                                    {"4-6", "4-6, 45% puntos ganados, 53% al servicio", "28 min. 723 pasos, 28º"}};
    ...
    // Pedir el drawable de imagen de fondo de la tarjeta
    @Override
